...
| **Future Research** | 🧪 Research | With entry filtering and exit rules both now tested and rejected, remaining levers are weighted voting, Kelly/regime-based trade sizing, and genuinely orthogonal directions (new asset class). |
