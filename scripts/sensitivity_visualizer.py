...
def plot_optimization_landscape(study, params_to_plot=['adx_threshold', 'atr_multiplier'], metric_name='Sharpe Ratio', results_manager=None):
    """
        ...
        if results_manager:
            ...
            if hasattr(fig, 'write_image'): # Plotly
                ...
                try:
                    ...
                    print(f"Failed to save Plotly image {filename}: {e}. Make sure 'kaleido' is installed.")
