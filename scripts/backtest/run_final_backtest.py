...
try:
    ...
    print(
        "Failed to import ggTrader modules. Make sure you are running from project root or scripts folder."
    )
    sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(description="Run final backtest.")
    parser.add_argument(
        "--symbols-file",
        type=str,
