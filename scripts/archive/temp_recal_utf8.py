...
def main():
    ...
    parser.add_argument(
        "--master-results", type=str, required=True, help="Path to Master WFO run_results.json"
    )
    ...
    master_config["RECENT_VALIDATION_START_DATE"] = (
    ...
    dump_data = {"configuration": {"_raw_config": master_config}, "results": wfo_results}
