...
| | WFO Full Range | YTD |
|-|----------------|--------|
| Strategy CAGR | -9.90% | -21.47% |
| BTC buy & hold CAGR | 39.06% ❌ | -23.23% ✅ |
| S&P 500 CAGR | 22.06% ❌ | 28.01% ❌ |
| Strategy Sharpe | -0.35 | -1.14 |
| Max Drawdown | -35.75% | -35.75% |
| Total Trades | 322 | 117 |
| Win Rate | 27.64% | 26.50% |
...
| Metric | Strategy | BTC (buy & hold) | S&P 500 (SPY) |
|--------|----------|------------------|---------------|
| Total Return | -21.45% | -23.20% | 27.97% |
| CAGR | -21.47% | -23.23% | 28.01% |
| Sharpe Ratio | -1.1404 | -0.4425 | 2.5426 |
| Max Drawdown | -35.75% | -49.89% | -7.54% |
| Total Trades | 117 | 1 | 1 |
| Win Rate | 26.50% | - | - |
...
|--------|----------|-----------|------------------|
| TRX-USD | psar_adx+atr_trailing | wfo_robustness | 0.7610 |
| DOGE-USD | adx_filtered_rsi+trailing_stop | wfo_robustness | 0.4911 |
| ETH-USD | psar_adx+atr_trailing | wfo_robustness | 0.3925 |
| ADA-USD | psar_adx+fixed_sl_tp | wfo_robustness | 0.2553 |
...
|--------|---------------|--------|---------|-------------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| TRX-USD | psar_adx+atr_trailing | 1.2213 | 0.7556 | 80% | 1.010 | 0.231 | 2.152 | 1.656 | 1.214 | 1.181 | 2.930 | -2.957 | -0.834 | 3.238 |
| ETH-USD | psar_adx+atr_trailing | 1.7308 | 0.0593 | 60% | -1.230 | 0.120 | 0.480 | -0.808 | -2.861 | 3.958 | 0.326 | 1.676 | -2.580 | 0.583 |
| DOGE-USD | adx_filtered_rsi+trailing_stop | 2.7123 | -0.0399 | 50% | 0.769 | -2.107 | -1.241 | 2.669 | -2.192 | 0.775 | 2.734 | -1.575 | -1.244 | 0.521 |
| ADA-USD | psar_adx+fixed_sl_tp | 1.6531 | -0.1249 | 50% | -0.485 | -1.539 | 0.289 | 5.297 | 0.289 | -3.184 | 2.933 | 0.373 | -3.297 | -0.465 |
