...
| | WFO Full Range | YTD |
|-|----------------|--------|
| Strategy CAGR | 26.37% | 39.62% |
| BTC buy & hold CAGR | 39.51% ❌ | -14.66% ✅ |
| S&P 500 CAGR | 22.17% ✅ | 31.05% ✅ |
| Strategy Sharpe | 1.08 | 1.18 |
| Max Drawdown | -26.23% | -17.88% |
| Total Trades | 263 | 71 |
| Win Rate | 37.26% | 45.07% |
...
|--------|----------|------------------|---------------|
| Total Return | 101.73% | 171.36% | 82.27% |
| CAGR | 26.37% | 39.51% | 22.17% |
| Sharpe Ratio | 1.0776 | 0.9569 | 1.3983 |
| Max Drawdown | -26.23% | -49.89% | -18.76% |
| Total Trades | 263 | 1 | 1 |
| Win Rate | 37.26% | - | - |
...
| Metric | Strategy | BTC (buy & hold) | S&P 500 (SPY) |
|--------|----------|------------------|---------------|
| Total Return | 39.57% | -14.64% | 31.01% |
| CAGR | 39.62% | -14.66% | 31.05% |
| Sharpe Ratio | 1.1835 | -0.1813 | 2.2338 |
| Max Drawdown | -17.88% | -49.89% | -8.88% |
| Total Trades | 71 | 1 | 1 |
| Win Rate | 45.07% | - | - |
...
| TRX-USD | adx_filtered_rsi+atr_trailing | wfo_robustness | 0.5401 |
| ZEC-USD | adx_filtered_rsi+atr_trailing | wfo_robustness | 0.5307 |
...
| SOL-USD | adx_filtered_rsi+atr_trailing | wfo_robustness | 0.3457 |
| ONDO-USD | adx_filtered_rsi+atr_trailing | wfo_robustness | 0.3214 |
...
| TRX-USD | adx_filtered_rsi+atr_trailing | 1.5301 | 0.5788 | 50% | 2.647 | -1.697 | -1.516 | 1.744 | -1.180 | -2.616 | 3.494 | -0.861 | 1.415 | 3.120 |
| PENGU-USD | rsi_reversal+atr_trailing | 2.8800 | 0.5627 | 80% | n/a | n/a | n/a | n/a | n/a | 2.676 | 2.536 | -2.757 | 0.091 | 1.458 |
| ZEC-USD | adx_filtered_rsi+atr_trailing | 1.4628 | 0.4561 | 60% | 1.788 | -0.570 | -3.009 | 2.064 | -2.425 | 0.229 | 0.244 | 5.112 | -1.475 | 1.462 |
...
| SOL-USD | adx_filtered_rsi+atr_trailing | 2.2882 | -0.1904 | 50% | -0.661 | -2.106 | -1.024 | 1.142 | 0.639 | 0.315 | 1.137 | -0.703 | -2.193 | 0.478 |
| LINK-USD | psar_adx+trailing_stop | 1.6514 | -0.1975 | 43% | 1.950 | -1.759 | n/a | -0.704 | -0.470 | -1.214 | 0.371 | 0.462 | n/a | n/a |
| ONDO-USD | adx_filtered_rsi+atr_trailing | 1.9621 | -0.2021 | 62% | n/a | n/a | 2.911 | 0.651 | -2.252 | -4.842 | 0.652 | 0.703 | -0.179 | 0.699 |
...
|--------|----------|------|-----------|----------|--------|----------|--------|-----------|
| ZEC-USD | adx_filtered_rsi | atr_trailing | wfo_robustness | 34.97% | 0.8764 | -12.98% | 58 | 41.38% |
...
| SOL-USD | adx_filtered_rsi | atr_trailing | wfo_robustness | 5.83% | 0.3195 | -12.92% | 72 | 38.89% |
| DOGE-USD | psar_adx | fixed_sl_tp | wfo_robustness | -0.15% | 0.0063 | -4.20% | 25 | 48.00% |
| TRX-USD | adx_filtered_rsi | atr_trailing | wfo_robustness | -0.53% | -0.0238 | -6.51% | 88 | 36.36% |
