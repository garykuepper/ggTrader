...
| | WFO Full Range | YTD |
|-|----------------|--------|
| Strategy CAGR | -3.73% | -5.70% |
| BTC buy & hold CAGR | 32.72% ❌ | -22.53% ✅ |
| S&P 500 CAGR | 19.71% ❌ | 23.52% ❌ |
| Strategy Sharpe | -0.08 | -0.24 |
| Max Drawdown | -32.66% | -22.39% |
| Total Trades | 566 | 193 |
| Win Rate | 33.22% | 27.46% |
...
|--------|----------|------------------|---------------|
| Total Return | -10.76% | 133.63% | 71.50% |
| CAGR | -3.73% | 32.72% | 19.71% |
| Sharpe Ratio | -0.0755 | 0.8464 | 1.1606 |
| Max Drawdown | -32.66% | -49.89% | -14.53% |
| Total Trades | 566 | 1 | 1 |
| Win Rate | 33.22% | - | - |
...
| Metric | Strategy | BTC (buy & hold) | S&P 500 (SPY) |
|--------|----------|------------------|---------------|
| Total Return | -5.69% | -22.51% | 23.49% |
| CAGR | -5.70% | -22.53% | 23.52% |
| Sharpe Ratio | -0.2382 | -0.3881 | 1.3368 |
| Max Drawdown | -22.39% | -49.89% | -7.49% |
...
|--------|----------|------|-----------|----------|--------|----------|--------|-----------|
| XRP-USD | supertrend_flip | atr_trailing | wfo_robustness | 19.49% | 0.6677 | -14.01% | 64 | 26.56% |
| BTC-USD | ema_cross | atr_trailing | wfo_robustness | 18.32% | 0.5346 | -18.39% | 1 | 100.00% |
| SOL-USD | ema_cross | atr_trailing | wfo_robustness | 8.25% | 0.4233 | -11.05% | 72 | 41.67% |
| TAO-USD | rsi_reversal | atr_trailing | wfo_robustness | 10.69% | 0.4014 | -12.07% | 31 | 35.48% |
| XLM-USD | rsi_reversal | fixed_sl_tp | wfo_robustness | 7.95% | 0.4008 | -9.89% | 90 | 32.22% |
| NEAR-USD | rsi_reversal | atr_trailing | wfo_robustness | -5.01% | -0.0278 | -26.27% | 1 | 0.00% |
| LINK-USD | rsi_reversal | atr_trailing | wfo_robustness | -2.29% | -0.0693 | -14.38% | 67 | 34.33% |
| XMR-USD | rsi_reversal | atr_trailing | wfo_robustness | -3.15% | -0.1447 | -10.91% | 43 | 30.23% |
| TRX-USD | rsi_reversal | fixed_sl_tp | wfo_robustness | -3.47% | -0.2700 | -8.51% | 101 | 30.69% |
| DOGE-USD | rsi_reversal | fixed_sl_tp | wfo_robustness | -8.03% | -0.3950 | -10.03% | 95 | 24.21% |
| TRUMP-USD | psar_adx | atr_trailing | wfo_robustness | -12.60% | -0.4822 | -21.77% | 36 | 33.33% |
| ETH-USD | psar_adx | fixed_sl_tp | wfo_robustness | -7.13% | -0.5875 | -8.13% | 102 | 40.20% |
| ADA-USD | rsi_reversal | fixed_sl_tp | wfo_robustness | -8.36% | -0.5921 | -12.27% | 107 | 28.97% |
| SUI-USD | psar_adx | trailing_stop | wfo_robustness | -14.32% | -0.7482 | -15.98% | 115 | 31.30% |
