...
| | WFO Full Range | YTD |
|-|----------------|--------|
| Strategy CAGR | -9.90% | -13.14% |
| BTC buy & hold CAGR | 39.06% ❌ | -23.82% ✅ |
| S&P 500 CAGR | 22.06% ❌ | 32.25% ❌ |
| Strategy Sharpe | -0.35 | -0.65 |
| Max Drawdown | -35.75% | -28.01% |
| Total Trades | 322 | 89 |
| Win Rate | 27.64% | 30.34% |
...
| Metric | Strategy | BTC (buy & hold) | S&P 500 (SPY) |
|--------|----------|------------------|---------------|
| Total Return | -13.12% | -23.80% | 32.20% |
| CAGR | -13.14% | -23.82% | 32.25% |
| Sharpe Ratio | -0.6538 | -0.4615 | 2.7294 |
| Max Drawdown | -28.01% | -49.89% | -7.54% |
| Total Trades | 89 | 1 | 1 |
| Win Rate | 30.34% | - | - |
...
| ETH-USD | psar_adx+atr_trailing | wfo_robustness | 0.3062 |
| ADA-USD | psar_adx+fixed_sl_tp | wfo_robustness | 0.1945 |
...
| ETH-USD | psar_adx+atr_trailing | 1.3199 | 0.0593 | 60% | -1.230 | 0.120 | 0.480 | -0.808 | -2.861 | 3.958 | 0.326 | 1.676 | -2.580 | 0.583 |
| DOGE-USD | adx_filtered_rsi+trailing_stop | 2.1629 | -0.0399 | 50% | 0.769 | -2.107 | -1.241 | 2.669 | -2.192 | 0.775 | 2.734 | -1.575 | -1.244 | 0.521 |
| ADA-USD | psar_adx+fixed_sl_tp | 1.3290 | -0.1249 | 50% | -0.485 | -1.539 | 0.289 | 5.297 | 0.289 | -3.184 | 2.933 | 0.373 | -3.297 | -0.465 |
