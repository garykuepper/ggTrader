...
| Sharpe Ratio | -0.2334 | -0.3167 | 1.5861 |
...
|--------|----------|-----------|------------------|
| PENGU-USD | psar_adx+atr_trailing | wfo_robustness | 1.3852 |
...
| ALGO-USD | ema_cross+fixed_sl_tp | wfo_robustness | 0.5371 |
| UNI-USD | rsi_reversal+atr_trailing | wfo_robustness | 0.5100 |
| WIF-USD | psar_adx+trailing_stop | wfo_robustness | 0.4985 |
| DASH-USD | macd_cross+atr_trailing | wfo_robustness | 0.4829 |
...
| VVV-USD | ema_cross+atr_trailing | wfo_robustness | 0.3579 |
| LINK-USD | psar_adx+trailing_stop | wfo_robustness | 0.3472 |
| SUI-USD | psar_adx+fixed_sl_tp | wfo_robustness | 0.3289 |
| ONDO-USD | psar_adx+fixed_sl_tp | wfo_robustness | 0.3259 |
| XCN-USD | psar_adx+atr_trailing | wfo_robustness | 0.3144 |
| BNB-USD | supertrend_flip+fixed_sl_tp | wfo_robustness | 0.2862 |
...
|--------|---------------|--------|---------|-------------|--------|--------|--------|--------|--------|--------|--------|--------|
| PENGU-USD | psar_adx+atr_trailing | 1.5582 | 1.3110 | 100% | n/a | n/a | n/a | n/a | 2.759 | 1.806 | n/a | 0.380 |
...
| WIF-USD | psar_adx+trailing_stop | 1.0409 | 0.4603 | 71% | 3.704 | 2.162 | 0.221 | n/a | 1.301 | -2.173 | -0.119 | 1.760 |
...
| DASH-USD | macd_cross+atr_trailing | 1.3602 | 0.3768 | 62% | -4.470 | -0.770 | 1.349 | 2.562 | -1.450 | 0.900 | 0.732 | 0.992 |
...
| ALGO-USD | ema_cross+fixed_sl_tp | 2.6550 | 0.0899 | 50% | -4.320 | -0.625 | 3.862 | -3.194 | 0.628 | 0.223 | -1.039 | 1.964 |
...
| XCN-USD | psar_adx+atr_trailing | 1.7200 | -0.1123 | 62% | 0.119 | -0.918 | 0.345 | 3.025 | -5.972 | 0.807 | -0.500 | 1.536 |
...
| ONDO-USD | psar_adx+fixed_sl_tp | 2.3904 | -0.3383 | 57% | -0.194 | 3.445 | 1.327 | -2.975 | n/a | 0.488 | -3.096 | 0.652 |
| VVV-USD | ema_cross+atr_trailing | 2.7585 | -0.3641 | 50% | n/a | n/a | n/a | n/a | 1.868 | -0.038 | -4.043 | 0.861 |
| BNB-USD | supertrend_flip+fixed_sl_tp | 2.2357 | -0.4130 | 67% | n/a | n/a | n/a | n/a | n/a | 1.075 | 0.941 | -3.043 |
